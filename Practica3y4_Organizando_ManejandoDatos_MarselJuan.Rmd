...
planes.f <- planes %>%
  ...
  filter(manufacturer != "MCDONNELL DOUGLAS CORPORATION" & manufacturer != "MCDONNELL DOUGLAS AIRCRAFT CO" & manufacturer != "MCDONNELL DOUGLAS" & manufacturer != "DOUGLAS") %>%
  ...
  mutate(manufacturer = ifelse(manufacturer %in% c("AIRBUS", "AIRBUS INDUSTRIE"), "AIRBUS COMP", manufacturer)
  )
