...
#Son todos vuelos directos? 
#Para determinar si todos los vuelos son directos, podemos verificar si hay vuelos con escalas.
flights %>%
  filter(origin == "JFK" & dest == "LAX") %>%
  summarise(num_vuelos_con_escala = sum(!is.na(air_time) & air_time > 0 & distance > 0 & air_time > (distance / 500))) # Suponiendo que un vuelo directo tiene una velocidad promedio de 500 mph 
```
